...
// Modified: gradient colors updated to match #00e38c accent
...
class CanvasTxt {
  constructor(txt, { fontSize = 200, fontFamily = 'Arial', color = '#00e38c' } = {}) {
    this.canvas = document.createElement('canvas');
    this.context = this.canvas.getContext('2d');
    this.txt = txt;
...
export default function AsciiText({
  ...
  return (
    <div ref={containerRef} className="ascii-text-container">
      <style>{`
